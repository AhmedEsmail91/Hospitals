                    ...
                    <div class="table-responsive">
                        <table id="example" class="table key-buttons text-md-nowrap">
                            ...
                            <tr>
                                ...
                                <th>{{trans('doctors.operations')}}</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($doctors as $doctor)
                                <tr>
                                    ...
                                    <td>
                                        @if($doctor->image)
                                            <img src="{{Url::asset('Dashboard/img/doctors/'.$doctor->image->filename)}}"
                                                 height="50px" width="50px" alt="Loading...">

                                        @else
                                            <img src="https://via.placeholder.com/100x100/0f0f0f" height="50px"
                                                 width="50px" alt="">
                                        @endif
                                    </td>
                                    <td>{{ $doctor->email }}</td>
                                    ...
                                    <td>
                                        ...
                                        {{$doctor->status == 1 ? trans('doctors.active'):trans('Doctors.n_active')}}
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            <button aria-expanded="false" aria-haspopup="true" class="btn ripple btn-outline-primary btn-sm" data-toggle="dropdown" type="button">{{trans('doctors.operations')}}<i class="fas fa-caret-down mr-1"></i></button>

...
<ul class="nav">
    <li class="">
        <div class="dropdown  nav-itemd-none d-md-flex">
            ...
            <div class="dropdown-menu dropdown-menu-{{App::getLocale()=='en'?'right':'left'}} dropdown-menu-arrow" x-placement="bottom-end">
                            ...
                            <div class="mb-5 d-flex"> <a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('Dashboard/img/brand/favicon.png')}}" class="sign-favicon ht-40" alt="logo"></a><h1 class="main-logo1 ml-1 mr-0 my-auto tx-28">Va<span>le</span>x</h1></div>
                                <div class="card-sigin">
                                    <div class="main-signup-header">
                                        ...
                                        <!-- Error Validaiton -->
                                        @if ($errors->any())
                                            <div class="alert alert-danger text-center text-bold rounded-sm">
                                                @foreach ($errors->all() as $error)
                                                    <b>{{ trans("Dashboard/auth.failed") }}</b>
                                                @endforeach
                                            </div>
                                        @endif
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="sectionChooser">
                                                ...
                                                <option value="ray_employee">{{trans('Dashboard/login_trans.x-ray')}}</option>
